...
class Dumper
{
    ...
    protected $styles = [
        'html' => [
            "pre" => "background-color:#262632;font: 13px monospace;line-height:1.2em;padding:3px 10px;text-align:left;color:#b9b5b8;margin:0;white-space:pre-wrap;word-wrap: break-word;",
        ],
    ];
