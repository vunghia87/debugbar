...
class XDebugParser
{
    ...
    function getTraceHTML()
    {
        ...
        foreach ($this->functions as $func) {
            ...
            $editorHrefA = '';
            if (!empty($func['file'])) {
                $editorHref = 'phpstorm://open?file=' . $func['file'] . '&line=' . $func['line'];
                $editorHrefA =  ' <a style="color:red" href="' . $editorHref . '">#</a>';
            }
            echo '<span class="file" title="' . htmlspecialchars($func['file'] . ':' . $func['line']) . '">' . htmlspecialchars(basename($func['file']) . ':' . $func['line']) . $editorHrefA. '</span>';
