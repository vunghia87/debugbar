<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between"><h5>Requests</h5>
    ...
    <table id="indexScreen" class="table table-hover table-sm mb-0 penultimate-column-right">
        ...
        <tr>
            ...
            <td title="<?= $item['__meta']['datetime'] ?>" class="table-fit"><?= time_human($item['__meta']['datetime']) ?></td>
            <td class="table-fit">
